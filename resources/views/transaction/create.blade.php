...
@else
    @section('title', 'Add New Transfer')
@endif
            ...
            <form action="{{ route('store_transaction') }}" method="POST">
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row fv-plugins-icon-container">
                            <!--begin::Label-->
                            <label class="required form-label" for="account_id">@if($type !== 3) Account @else
                                    From @endif</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <select class="form-control" name="account_id" id="account_id" data-control="select2"
                                ...
                                @foreach($accounts as $account)
                                    <option @if(intval(old('account_id')) ===  $account->id) selected="selected"
                    ...
                    @if($type !== 3)
                        ...
                        @isset($parties)
                            <!--begin::Input group-->
                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                    <!--begin::Label-->
                                    <label class="form-label" for="party_id">@if(intval($type) === 1)
                                            Payer @elseif (intval($type) === 2) Payee @else Party @endif</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
