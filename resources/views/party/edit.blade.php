...
@section('content')
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            <form action="{{ route('update_party', $party->id) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row fv-plugins-icon-container">
                            ...
                            <input type="text" name="company" id="company" class="form-control mb-2"
                                   placeholder="Company name" value="{{ $party->company }}">
                            <!--end::Input-->
                            <div class="fv-plugins-message-container invalid-feedback"></div>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="mb-10 fv-row fv-plugins-icon-container">
                            ...
                            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-1 row-cols-xl-2 g-9"
                                ...
                                <div class="col">
                                    <!--begin::Option-->
                                    <label
                                        class="btn btn-outline btn-outline-dashed btn-outline-default @if($party->type == 1) active @endif d-flex text-start p-6"
                                        data-kt-button="true">
                                        <!--begin::Radio-->
                                        <span
                                            ...
                                            <input class="form-check-input"
                                                   type="radio"
                                                   name="type" value="1"
                                                   @if($party->type == 1) checked="checked" @endif />
                                        </span>
                                        <!--end::Radio-->
                                        <!--begin::Info-->
                                        <span class="ms-5">
                                ...
                                <div class="col">
                                    <!--begin::Option-->
                                    <label
                                        class="btn btn-outline btn-outline-dashed btn-outline-default @if($party->type == 2) active @endif d-flex text-start p-6"
                                        data-kt-button="true">
                                        <!--begin::Radio-->
                                        <span
                                            class="form-check form-check-custom form-check-solid form-check-sm align-items-start mt-1">
                                            <input class="form-check-input" type="radio" name="type" @if($party->type == 2) checked="checked" @endif value="2"/>
                                        </span>
                                        <!--end::Radio-->
                                        <!--begin::Info-->
                                        <span class="ms-5">
                        ...
                        <div class="mb-10 fv-row fv-plugins-icon-container">
                            ...
                            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-1 row-cols-xl-2 g-9"
                                ...
                                <div class="col">
                                    <!--begin::Option-->
                                    <label
                                        class="btn btn-outline btn-outline-dashed btn-outline-success @if($party->status == 1) active @endif d-flex text-start p-6"
                                        data-kt-button="true">
                                        <!--begin::Radio-->
                                        <span
                                            class="form-check form-check-custom form-check-solid form-check-sm align-items-start mt-1">
                                            <input class="form-check-input"
                                                   type="radio"
                                                   name="status" value="1"
                                                   @if($party->status == 1) checked="checked" @endif/>
                                        </span>
                                        <!--end::Radio-->
                                        <!--begin::Info-->
                                        <span class="ms-5">
                                ...
                                <div class="col">
                                    <!--begin::Option-->
                                    <label
                                        class="btn btn-outline btn-outline-dashed btn-outline-danger @if($party->status == 0) active @endif d-flex text-start p-6"
                                        data-kt-button="true">
                                        <!--begin::Radio-->
                                        <span
                                            class="form-check form-check-custom form-check-solid form-check-sm align-items-start mt-1">
                                            <input class="form-check-input" type="radio" name="status" value="0" @if($party->status == 0) checked="checked" @endif />
                                        </span>
                                        <!--end::Radio-->
                                        <!--begin::Info-->
                                        <span class="ms-5">
                        ...
                        <div class="d-flex justify-content-end">
                            <!--begin::Button-->
                            <button type="reset" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">Reset</button>
                            <!--end::Button-->
                            <!--begin::Button-->
