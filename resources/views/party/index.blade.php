                        ...
                        @isset($parties)
                            ...
                            @foreach($parties as $party)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(intval($party->type) === 1)
                                            <div class="badge badge-light-info">Supplier</div>
                                        @else
                                            <div class="badge badge-light-primary">Customer</div>
                                        @endif
                                    </td>
                                    <td>
                                        @if(intval($party->status) === 1)
                                        ...
                                        @if(intval(Auth::user()->user_type) === 1)
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('edit_party', $party->id) }}"
                                                ...
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <form action="{{ route('delete_party', $party->id) }}" method="post"
                                                          class="deleteForm">
                                                        @csrf
                                                        @method('delete')
