<div id="kt_header" style="" class="header align-items-stretch">
    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
            ...
            <!--end::Navbar-->
            <!--begin::Topbar-->
            <div class="d-flex align-items- flex-shrink-0">
                        ...
                        <div data-kt-search-element="content"
                            ...
                            <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                                ...
                                <div class="d-flex justify-content-end">
                                    ...
                                    <a href="../../demo13/dist/pages/search/horizontal.html"
                ...
                <div class="d-flex align-items-stretch">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px"
                        ...
                        <div class="row g-0">
                            <!--begin:Item-->
                            <div class="col-6">
                                <a href="../../demo13/dist/apps/projects/budget.html"
                            ...
                            <!--begin:Item-->
                            <div class="col-6">
                                <a href="../../demo13/dist/apps/projects/settings.html"
                            ...
                            <!--begin:Item-->
                            <div class="col-6">
                                <a href="../../demo13/dist/apps/projects/list.html"
                            ...
                            <!--begin:Item-->
                            <div class="col-6">
                                <a href="../../demo13/dist/apps/projects/users.html"
                    ...
                    <div class="d-flex align-items-stretch" id="kt_header_user_menu_toggle">
                        ...
                        <div
                            ...
                            <div class="menu-item px-5 my-1">
                                <a href="{{ route('users_index') }}" class="menu-link px-5">Users
                                    Settings</a>
                            </div>
                            <!--end::Menu item-->
                            @endif
                            ...
                            <!--begin::Menu item-->
                            <div class="menu-item px-5 my-1">
                                <a href="{{ route('current_user_setting') }}" class="menu-link px-5">Account
                                    Settings</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-5 my-1">
                                <a href="{{ route('change_current_user_password') }}" class="menu-link px-5">Change
                                    Password</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu separator-->
                            ...
                            <div class="menu-item px-5">
                                ...
                                <a href="#" onclick="$('#logout-form').submit()" class="menu-link px-5">Sign Out
                                </a>
                            </div>
                            <!--end::Menu item-->
