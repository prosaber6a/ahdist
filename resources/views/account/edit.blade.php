                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row fv-plugins-icon-container">
                            ...
                            <input type="text" name="branch" id="branch" class="form-control mb-2"
                                   placeholder="Branch" value="{{ $account->branch }}">
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="mb-10 fv-row fv-plugins-icon-container">
                            ...
                            <input type="text" name="name" id="name" class="form-control mb-2"
                                   placeholder="Acc. Holder Name" value="{{ $account->name }}">
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="mb-10 fv-row fv-plugins-icon-container">
                            ...
                            <input type="text" name="acc_no" id="acc_no" class="form-control mb-2"
                                   placeholder="Acc. No" value="{{ $account->acc_no }}">
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="mb-10 fv-row fv-plugins-icon-container">
                            ...
                            <input type="text" name="initial_balance" id="initial_balance" class="form-control mb-2"
                                   placeholder="Initial Balance" value="{{ $account->initial_balance }}">
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="mb-10 fv-row fv-plugins-icon-container">
                            ...
                            <textarea class="form-control" name="note" id="note" cols="30" rows="5"
                                      placeholder="Address">{{ $account->note }}</textarea>
                            <!--end::Editor-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="mb-10 fv-row fv-plugins-icon-container">
                            ...
                            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-1 row-cols-xl-2 g-9"
                                ...
                                <div class="col">
                                    <!--begin::Option-->
                                    <label
                                        class="btn btn-outline btn-outline-dashed btn-outline-success @if(intval($account->status) === 1) active @endif d-flex text-start p-6"
                                        data-kt-button="true">
                                        <!--begin::Radio-->
                                        <span
                                            ...
                                            <input class="form-check-input"
                                                   type="radio"
                                                   name="status" value="1"
                                                   @if(intval($account->status) === 1) checked="checked" @endif/>
                                        </span>
                                        <!--end::Radio-->
                                        <!--begin::Info-->
                                        <span class="ms-5">
                                ...
                                <div class="col">
                                    <!--begin::Option-->
                                    <label
                                        class="btn btn-outline btn-outline-dashed btn-outline-danger @if(intval($account->status) === 0) active @endif d-flex text-start p-6"
                                        data-kt-button="true">
                                        <!--begin::Radio-->
                                        <span
                                            class="form-check form-check-custom form-check-solid form-check-sm align-items-start mt-1">
                                            <input class="form-check-input" type="radio" name="status" value="0" @if(intval($account->status) === 0) checked="checked" @endif />
                                        </span>
                                        <!--end::Radio-->
                                        <!--begin::Info-->
                                        <span class="ms-5">
