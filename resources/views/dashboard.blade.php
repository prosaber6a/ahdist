    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            var jsonData = JSON.parse($.ajax({
                url: "/api/last_month_sales_vs_purhcase",
                async: false
            }).responseText);
            ...
            var options = {
                title: 'Sales VS Purchase of {{ date('F, Y') }}',
                hAxis: {title: 'Day of the month', titleTextStyle: {color: '#333'}},
                vAxis: {title: 'Amount', minValue: 0}
            };

            var chart = new google.visualization.AreaChart(document.getElementById('sales_vs_pruchase_chart'));
            chart.draw(data, options);
        }

        $.ajax({
            url: '/api/last_10_transaction',
            method: 'GET',
            success: function(response) {
                ...
                $('#last_10_transaction_table tbody').html(tr);
            }
        })
    </script>
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <div class="row gy-5 g-xl-8">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div id="sales_vs_pruchase_chart" style="min-height: 500px;"></div>
                        </div>
                    </div>
                </div>
                <!--end::Col-->
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-row-dashed table-row-gray-200 align-middle gs-0 gy-4" id="last_10_transaction_table">
                                <thead>
                                    <th>Date</th>
                                    <th>Description</th>
                                    <th>Debit</th>
